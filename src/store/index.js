...
export default createStore({
    state: {
        ...
        aboutMeDescription: "Я являюсь веб-разработчиком из города Липецка. В настоящее время веду трудовую деятельность на фрилансе. Постоянно повышаю свои личностные и профессиональные навыки в веб-разработке.",
        ...
        contactDescription: "Вы работаете над чем-то большим? Я хотел бы помочь вам в реализации задач. Напишите мне письмо и начните свой проект прямо сейчас! Просто сделайте это.",
    },
